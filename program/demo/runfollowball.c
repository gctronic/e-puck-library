...
int cam_width=120, cam_heigth=1, cam_zoom=4;
...
void select_cam_mode(int mode)
{
	// The following setting need to be used for the cameras: PO3030 (no rotation), PO6030, PO8030.
	e_poxxxx_config_cam((ARRAY_WIDTH - cam_width * cam_zoom) / 2, (ARRAY_HEIGHT - cam_heigth * cam_zoom) / 2, cam_width*cam_zoom, cam_heigth*cam_zoom, cam_zoom, cam_zoom, mode);
     
	// The following setting need to be used with the camera PO3030 (-90 rotation).
